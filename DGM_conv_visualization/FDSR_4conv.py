...
class FDSR(nn.Module):
    def __init__(self, scale, freq_c=8, c=64, mode="ideal", color_channel=3, freq_order="l2h", DGM_up_method="bicubic", conv_in_DGM="default"):
        ...
        self.displacement = Displacement_generate(scale, DGM_up_method, color_channel=color_channel, conv=conv_in_DGM)
