...
model_list = ["DeFiAN", "FDSR_RK2_32_DS", "MSRN", "OISR"]
name_list = ["DeFiAN-s", "FDSR w/ FDL", "MSRN", "OISR-RK2"]
base_model = ["edsr_baseline", "rcan"]
model_name_in_title = ["EDSR_baseline", "RCAN"]
eps = [1, 2, 4, 8, 16, 32]
...
for model, title_model_name in zip(base_model, model_name_in_title):
    ...
    plt.title(title_str, y=-0.3, fontproperties="Times New Roman", fontsize=15)
