    ...
    def __test_pre_or_init(self, net, loader, is_normal, test_patch):
        ...
        for _, data in enumerate(loader):
            ...
            if test_patch == None:
                ...
                #     _, sr = net(lr.to(self.sys_conf.device_in_prog))
                # else:
                if ("_DS" in net.__class__.__name__) and ("FDSR" in net.__class__.__name__):
                    sr, _ = net(lr.to(self.sys_conf.device_in_prog))
                else:
